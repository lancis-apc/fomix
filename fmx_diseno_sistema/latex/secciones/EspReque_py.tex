...
\begin{longtable}{@{\extracolsep{8pt}}l p{8.5cm}}
\caption{Caso de uso: Consultar documento relacionado con la formulación del POETY  }\label{item: consultar_documento_relacionado_con_la_formulacion_del_poety }\\
\\[-1.8ex]\hline
\endhead
\hline \\[-1.8ex]
...
\hline\\[-1ex]
ACTORES PARTICIPANTES & 
\par - Usuario de interno de la SDS

\par - Sistema interno de la SDS
