...
UNION SELECT a.cve_mun, a.fol_ageb, b.año, c.adpr_id, d.adpc_id, 2 AS adp_id
FROM auxiliar.bd_ageb_diag_pobr AS a
...
UNION SELECT a.cve_mun, CAST(c.año AS SMALLINT), a.afr_parc, 2 AS pa_id
FROM auxiliar.bd_pob_afrodesc AS a
JOIN auxiliar.dd_pob_afrodesc AS c ON c.nombre = 'afr_parc'
UNION SELECT a.cve_mun, CAST(c.año AS SMALLINT), a.afr_no, 3 AS pa_id
FROM auxiliar.bd_pob_afrodesc AS a
JOIN auxiliar.dd_pob_afrodesc AS c ON c.nombre = 'afr_no'
UNION SELECT a.cve_mun, CAST(c.año AS SMALLINT), a.afr_ns, 4 AS pa_id
FROM auxiliar.bd_pob_afrodesc AS a
JOIN auxiliar.dd_pob_afrodesc AS c ON c.nombre = 'afr_ns'
UNION SELECT a.cve_mun, CAST(c.año AS SMALLINT), a.afr_ne, 5 AS pa_id
FROM auxiliar.bd_pob_afrodesc AS a
...
WITH wo_total AS (
    SELECT cve_mun, gpo_quin, CAST(pobqm_15 AS INTEGER), CAST(pobqf_15 AS INTEGER)
    FROM auxiliar.bd_pob_gpo_edad_quinq
    WHERE gpo_quin != 'Total')
...
UNION SELECT a.cve_geo, a.cve_mun, b.año, a.p_pbr_10, CAST(a.h_pb_10 AS INTEGER), 2 AS pb_id
FROM auxiliar.bd_socioec_diagn AS a
JOIN auxiliar.dd_socioec_diagn AS b ON b.nombre = 'p_pbr_10'
UNION SELECT a.cve_geo, a.cve_mun, b.año, a.p_pm_10, CAST(a.h_pm_10 AS INTEGER), 3 AS pb_id
FROM auxiliar.bd_socioec_diagn AS a
JOIN auxiliar.dd_socioec_diagn AS b ON b.nombre = 'p_pm_10'
UNION SELECT a.cve_geo, a.cve_mun, b.año, a.p_pex_10, CAST(a.h_pex_10 AS INTEGER), 4 AS pb_id
FROM auxiliar.bd_socioec_diagn AS a
JOIN auxiliar.dd_socioec_diagn AS b ON b.nombre = 'p_pex_10'
UNION SELECT a.cve_geo, a.cve_mun, b.año, a.p_vu_15, CAST(a.h_vu_15 AS INTEGER), 1 AS pb_id
FROM auxiliar.bd_socioec_diagn AS a
JOIN auxiliar.dd_socioec_diagn AS b ON b.nombre = 'p_vu_15'
UNION SELECT a.cve_geo, a.cve_mun, b.año, a.p_pbr_15, CAST(a.h_pb_15 AS INTEGER), 2 AS pb_id
FROM auxiliar.bd_socioec_diagn AS a
JOIN auxiliar.dd_socioec_diagn AS b ON b.nombre = 'p_pbr_15'
UNION SELECT a.cve_geo, a.cve_mun, b.año, a.p_pm_15, CAST(a.h_pm_15 AS INTEGER), 3 AS pb_id
FROM auxiliar.bd_socioec_diagn AS a
JOIN auxiliar.dd_socioec_diagn AS b ON b.nombre = 'p_pm_15'
UNION SELECT a.cve_geo, a.cve_mun, b.año, a.p_pex_15, CAST(a.h_pex_15 AS INTEGER), 4 AS pb_id
FROM auxiliar.bd_socioec_diagn AS a
