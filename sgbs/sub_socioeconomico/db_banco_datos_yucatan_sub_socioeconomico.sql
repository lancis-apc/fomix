...
CREATE TABLE IF NOT EXISTS development.ct_grados(
...
CREATE TABLE IF NOT EXISTS development.ct_socioec_diagn_rz(
    sdrz_id SMALLINT PRIMARY KEY,
    descripcion VARCHAR(20) NOT NULL
);

--Se crea catalogo para el archivo bd_socioec_diagn.csv
CREATE TABLE IF NOT EXISTS development.ct_socioec_diagn_pb(
    pb_id SERIAL PRIMARY KEY,
    descripcion VARCHAR(50) NOT NULL
);

--Se crea catalogo para el archivo bd_socioec_diagn.csv para separar según pocentajes
CREATE TABLE IF NOT EXISTS development.ct_socioec_diagn_prc(
...
CREATE TABLE IF NOT EXISTS development.socioec_diagn_rz(
    cve_geo CHAR(5) NOT NULL,
    cve_mun CHAR(3) NOT NULL REFERENCES development.municipios(clave_municipio),
    serie SMALLINT NOT NULL,
    indice NUMERIC(4,3),
    ctg_id SMALLINT NOT NULL REFERENCES development.ct_grados(ctg_id),
    sdrz_id SMALLINT NOT NULL REFERENCES development.ct_socioec_diagn_rz(sdrz_id)
);

--Se crea tabla para registros del archivo bd_socioec_diagn.csv
CREATE TABLE IF NOT EXISTS development.socioec_diagn_pb(
    cve_geo CHAR(5) NOT NULL,
    cve_mun CHAR(3) NOT NULL REFERENCES development.municipios(clave_municipio),
    serie SMALLINT NOT NULL,
    porcentaje NUMERIC(4,1),
    habitantes INTEGER,
    pb_id SMALLINT NOT NULL REFERENCES development.ct_socioec_diagn_pb(pb_id)
);

--Se crea tabla para registros del archivo bd_socioec_diagn.csv
CREATE TABLE IF NOT EXISTS development.socioec_diagn_prc(
    cve_geo CHAR(5) NOT NULL,
    cve_mun CHAR(3) NOT NULL REFERENCES development.municipios(clave_municipio),
    serie SMALLINT NOT NULL,
    porcentaje NUMERIC(4,1),
    sdp_id SMALLINT NOT NULL REFERENCES development.ct_socioec_diagn_prc(sdp_id)
);