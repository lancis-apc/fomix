...
DELETE FROM development.tb_sector;
COPY development.tb_sector (sector,descripcion)
...
DELETE FROM development.tb_subsector;
COPY development.tb_subsector(act_ec_sub_cod,subsector)
