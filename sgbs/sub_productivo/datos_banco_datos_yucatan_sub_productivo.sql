/*
    ********************************************************
    Esta sección es la información es para el sub_productivo
    ********************************************************
*/
...
INSERT INTO sub_productivo.ct_sectores(sector, descripcion)
SELECT sector, descripcion FROM auxiliar.tb_sector;

-- Se ingresan los valores al catalogo de subsectores
INSERT INTO sub_productivo.ct_subsectores(act_ec_sub_cod, subsector)
SELECT act_ec_sub_cod, subsector FROM auxiliar.tb_subsector;

-- Se ingresan los valores del catálogo de rama
INSERT INTO sub_productivo.ct_ramas(act_ec_cod, rama, act_ec_sub_cod)
SELECT act_ec_cod, rama, LEFT(act_ec_cod,2) AS act_ec_sub_cod FROM auxiliar.tb_rama;

-- Se ingresan los valores para el catalogo del archivo bd_coef_esp.csv
INSERT INTO sub_productivo.ct_coef_esp(ce_id, descripcion)
VALUES
...
INSERT INTO sub_productivo.ct_coef_tec(ct_id, descripcion)
VALUES
...
INSERT INTO sub_productivo.ct_conc_indust(ci_id, descripcion)
...
INSERT INTO sub_productivo.ct_denue(denue_id, descripcion)
VALUES
...
INSERT INTO sub_productivo.ct_mat_tc(mt_id, descripcion)
VALUES
...
INSERT INTO sub_productivo.ct_pib(pib_id, descripcion)
VALUES
...
INSERT INTO sub_productivo.ct_act_ec_valores(valor_id, descripcion)
VALUES
...
INSERT INTO sub_productivo.ct_act_ec_cantidades(cantidad_id, descripcion)
VALUES
...
/*
    ******************************************
    Sobre las tablas del componente sub_productivo
    ******************************************
*/
...
SELECT sector, agr_pesca_coef, 1 FROM auxiliar.bd_coef_tec UNION
SELECT sector, mineria_coef, 2 FROM auxiliar.bd_coef_tec UNION
SELECT sector, en_elec_coef, 3 FROM auxiliar.bd_coef_tec UNION
SELECT sector, construc_coef, 4 FROM auxiliar.bd_coef_tec UNION
SELECT sector, manufac_coef, 5 FROM auxiliar.bd_coef_tec UNION
SELECT sector, comercio_coef, 6 FROM auxiliar.bd_coef_tec UNION
SELECT sector, trans_cor_coef, 7 FROM auxiliar.bd_coef_tec UNION
SELECT sector, med_masiv_coef, 8 FROM auxiliar.bd_coef_tec UNION
SELECT sector, s_finan_coef, 9 FROM auxiliar.bd_coef_tec UNION
SELECT sector, s_inmob_coef, 10 FROM auxiliar.bd_coef_tec UNION
SELECT sector, s_prof_coef, 11 FROM auxiliar.bd_coef_tec UNION
SELECT sector, corporat_coef, 12 FROM auxiliar.bd_coef_tec UNION
SELECT sector, s_ap_neg_coef, 13 FROM auxiliar.bd_coef_tec UNION
SELECT sector, s_educ_coef, 14 FROM auxiliar.bd_coef_tec UNION
SELECT sector, s_salud_coef, 15 FROM auxiliar.bd_coef_tec UNION
SELECT sector, s_espar_coef, 16 FROM auxiliar.bd_coef_tec UNION
SELECT sector, s_aloj_alm_coef, 17 FROM auxiliar.bd_coef_tec UNION
SELECT sector, ot_serv_coef, 18 FROM auxiliar.bd_coef_tec UNION
...
SELECT act_ec_cod, serie, CAST(tc_inv_total_rama AS NUMERIC(10,6)), 1 FROM auxiliar.bd_mat_tc_rama UNION
SELECT act_ec_cod, serie, tc_per_ocupado_rama, 2 FROM auxiliar.bd_mat_tc_rama UNION
SELECT act_ec_cod, serie, tc_prod_brut_tot_rama, 3 FROM auxiliar.bd_mat_tc_rama UNION
SELECT act_ec_cod, serie, tc_ue_rama, 4 FROM auxiliar.bd_mat_tc_rama;

-- Se ingresan la información del archivo bd_mat_tc_subsector.csv
INSERT INTO sub_productivo.mat_tc_subsector(act_ec_sub_cod, serie, tasa, mt_id)
SELECT act_ec_sub_cod, serie, tc_inv_total_subsector, 1 FROM auxiliar.bd_mat_tc_subsector UNION
SELECT act_ec_sub_cod, serie, tc_per_ocupado_subsector, 2 FROM auxiliar.bd_mat_tc_subsector UNION
SELECT act_ec_sub_cod, serie, tc_prod_brut_tot_subsector, 3 FROM auxiliar.bd_mat_tc_subsector UNION
SELECT act_ec_sub_cod, serie, tc_ue_subsector, 4 FROM auxiliar.bd_mat_tc_subsector;

-- Se ingresan la información del archivo bd_pib_yucatan.csv
INSERT INTO sub_productivo.pib(serie, millones_pesos, pib_id)
SELECT serie, pib_prim, 1 FROM auxiliar.bd_pib_yucatan UNION
SELECT serie, pib_sec, 2 FROM auxiliar.bd_pib_yucatan UNION
