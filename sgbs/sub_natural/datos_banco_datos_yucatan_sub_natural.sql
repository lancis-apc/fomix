...
INSERT INTO sub_natural.ct_coberturas_c3(cob_c3_id, cobertura_c3) VALUES 
    (1,'Natural'),
    (2,'No natural');

--Se ingresa la información de la tabla coberturas_c4
INSERT INTO sub_natural.ct_coberturas_c4(cob_c4_id, cobertura_c4, cob_c3_id) VALUES 
    (1,'Asentamiento humano', 2),
    (2,'Agropecuario', 2),
    (3,'Natural',1);

--Se ingresa la información de la tabla coberturas_c2
INSERT INTO sub_natural.ct_coberturas_c2(cob_c2_id, cobertura_c2, cob_c4_id) VALUES 
...
INSERT INTO sub_natural.usv_municipios_coberturas(cve_ent, cve_mun, serie,cobertura, cob_c2_id)
SELECT cve_ent, cve_mun, serie, cob_1, 1
FROM auxiliar.bd_usv_c2_mun
UNION SELECT cve_ent, cve_mun, serie, cob_2, 2
FROM auxiliar.bd_usv_c2_mun
UNION SELECT cve_ent, cve_mun, serie, cob_3, 3
FROM auxiliar.bd_usv_c2_mun
UNION SELECT cve_ent, cve_mun, serie, cob_4, 4
FROM auxiliar.bd_usv_c2_mun
UNION SELECT cve_ent, cve_mun, serie, cob_5, 5
FROM auxiliar.bd_usv_c2_mun
UNION SELECT cve_ent, cve_mun, serie, cob_6, 6
FROM auxiliar.bd_usv_c2_mun
UNION SELECT cve_ent, cve_mun, serie, cob_7, 7
FROM auxiliar.bd_usv_c2_mun
UNION SELECT cve_ent, cve_mun, serie, cob_8, 8
FROM auxiliar.bd_usv_c2_mun
UNION SELECT cve_ent, cve_mun, serie, cob_9, 9
FROM auxiliar.bd_usv_c2_mun
UNION SELECT cve_ent, cve_mun, serie, cob_10, 10
FROM auxiliar.bd_usv_c2_mun
UNION SELECT cve_ent, cve_mun, serie, cob_11, 11
FROM auxiliar.bd_usv_c2_mun
UNION SELECT cve_ent, cve_mun, serie, cob_12, 12
FROM auxiliar.bd_usv_c2_mun
UNION SELECT cve_ent, cve_mun, serie, cob_13, 13
FROM auxiliar.bd_usv_c2_mun
UNION SELECT cve_ent, cve_mun, serie, cob_14, 14
FROM auxiliar.bd_usv_c2_mun
UNION SELECT cve_ent, cve_mun, serie, cob_15, 15
FROM auxiliar.bd_usv_c2_mun
UNION SELECT cve_ent, cve_mun, serie, cob_16, 16
FROM auxiliar.bd_usv_c2_mun;
...
--Se ingresa la información de la tabla auxiliar.bd_usv_c2_mun en auxiliar.usv_municipios_coberturas
INSERT INTO sub_natural.anp_municipios_coberturas(cve_ent, cve_mun, serie,cobertura, cob_c2_id)
SELECT cve_ent, cve_mun, serie, cob_1, 1
...
--Se ingresa la información de la tabla auxiliar.bd_usv_c2_mun en auxiliar.usv_municipios_coberturas
INSERT INTO sub_natural.deg_municipios_coberturas(cve_ent, cve_mun, serie,cobertura, cob_c2_id)
SELECT cve_ent, cve_mun, serie, cob_1, 1
