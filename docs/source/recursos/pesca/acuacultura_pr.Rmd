...
![](fi_fv_acuasal_bio_nivel_estatico.png)

**Función de valor de acceso de agua**

![](mapa_fv_acuasal_bio_nivel_estatico.png)
...
![](fi_fv_acuasal_bio_espesor_agua_salada.png)

**Función de valor de salinidad**

![](mapa_fv_acuasal_bio_espesor_agua_salada.png)
...
![](mapa_fv_acuasal_bio_cobertura_usv_svi_16cats.png)
...
![](fi_fv_acuasal_infra_d_lineas_electricas.png)

**Función de valor de electricidad**

![](mapa_fv_acuasal_infra_d_lineas_electricas.png)
...
![](fi_fv_acuasal_infra_d_carreteras_caminos.png)

**Función de valor de vías de comunicación**

![](mapa_fv_acuasal_infra_d_carreteras_caminos.png)
...
![](mapa_fv_acuasal_socio_tenencia_tierra.png)
...
![](fi_analisis_sensibilidad_acuacultura_salobre.png)
...
![](fi_fv_acuadul_bio_nivel_estatico.png)

**Función de valor de acceso a agua**

![](mapa_fv_acuadul_bio_nivel_estatico.png)
...
![](fi_fv_acuadul_bio_espesor_agua_dulce.png)

**Función de valor de salinidad**

![](mapa_fv_acuadul_bio_espesor_agua_dulce.png)
...
![](mapa_fv_acuadul_bio_cobertura_usv_svi_16cats.png)
...
![](fi_fv_acuadul_infra_d_lineas_electricas.png)

**Función de valor de electricidad**

![](mapa_fv_acuadul_infra_d_lineas_electricas.png)
...
![](mapa_fv_acuadul_socio_tenencia_tierra.png)
...
![](fi_analisis_sensibilidad_acuacultura_dulce.png)
